...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=DARKX-ULTRA&fontSize=72&fontColor=fff&animation=twinkling&fontAlignY=32&desc=High%20Performance%20WhatsApp%20Bot&descAlignY=55&descSize=20" width="100%"/>
...
[![Version](https://img.shields.io/badge/Version-6.0.0-blue?style=for-the-badge&logo=github)](https://github.com/darkx-ultra-bot/DARKX-ULTRA)
...
[![Stars](https://img.shields.io/github/stars/darkx-ultra-bot/DARKX-ULTRA?style=for-the-badge&logo=starship&color=gold)](https://github.com/darkx-ultra-bot/DARKX-ULTRA/stargazers)
[![Forks](https://img.shields.io/github/forks/darkx-ultra-bot/DARKX-ULTRA?style=for-the-badge&logo=git&color=orange)](https://github.com/darkx-ultra-bot/DARKX-ULTRA/network/members)
...
```bash
git clone https://github.com/darkx-ultra-bot/DARKX-ULTRA.git
cd DARKX-ULTRA
npm install
cp sample.env .env
...
1. Enter your bot's WhatsApp number with country code (e.g. 255775710774)
...
```env
SESSION_ID=darkx-ultra-bot/DARKX-ULTRA_xxxxxxxxxxxxxxxxxxxxxxxx
```
...
```env
# ── REQUIRED (choose one) ────────────────────────────────────
SESSION_ID=darkx-ultra-bot/DARKX-ULTRA_your_gist_id_here
# OR
PAIRING_NUMBER=255775710774

# ── REQUIRED ─────────────────────────────────────────────────
OWNER_NUMBER=255775710774        # No + sign

# ── BOT IDENTITY ─────────────────────────────────────────────
BOT_NAME=DARKX-ULTRA
BOT_OWNER=Mr X Developer
...
```bash
sudo bash <(curl -fsSL https://raw.githubusercontent.com/darkx-ultra-bot/DARKX-ULTRA/main/lib/install.sh)
```
...
```bash
# After install:
nano /root/DARKX-ULTRA/.env
cd /root/DARKX-ULTRA && pm2 start dist/index.js --name darkx-ultra
...
tmux new -s darkx-ultra    # Start new session
npm start

# Detach:     Ctrl+B → D
# Re-attach:  tmux attach -t darkx-ultra
# List:       tmux ls
# Kill:       tmux kill-session -t darkx-ultra
```
...
# Keep alive with PM2
npm install -g pm2
pm2 start dist/index.js --name darkx-ultra
pm2 save && pm2 startup
```
...
Command Description
pm2 logs darkx-ultra Live logs
pm2 restart darkx-ultra Restart
pm2 stop darkx-ultra Stop
...
https://img.shields.io/badge/Windows_11-0078D4?style=flat-square&logo=windows11&logoColor=white
...
https://img.shields.io/badge/Replit-F26207?style=flat-square&logo=replit&logoColor=white

[!NOTE]
The repo includes pre-configured .replit and replit.nix.

1. Go to replit.com → Create Repl → Import from GitHub
2. Paste: https://github.com/darkx-ultra-bot/DARKX-ULTRA
3. Open Secrets tab (🔒) and add:
   Key Value
   SESSION_ID darkx-ultra-bot/DARKX-ULTRA_your_gist_id
...
```bash
bash <(curl -s https://raw.githubusercontent.com/darkx-ultra-bot/DARKX-ULTRA/main/lib/heroku.sh)
```
...
heroku config:set SESSION_ID=darkx-ultra-bot/DARKX-ULTRA_your_gist_id
heroku config:set OWNER_NUMBER=255775710774
...
https://img.shields.io/badge/Render-46E3B7?style=flat-square&logo=render&logoColor=black
...
https://img.shields.io/badge/Koyeb-121212?style=flat-square&logo=koyeb&logoColor=white

1. Fork this repo
2. app.koyeb.com → Create App → GitHub
...
https://img.shields.io/badge/Fly.io-7B3FE4?style=flat-square&logo=flydotio&logoColor=white
...
```bash
bash <(curl -s https://raw.githubusercontent.com/darkx-ultra-bot/DARKX-ULTRA/main/lib/fly.sh)
```
...
fly secrets set SESSION_ID=darkx-ultra-bot/DARKX-ULTRA_your_gist_id
fly secrets set OWNER_NUMBER=255775710774
fly deploy
...
```bash
# Build image
docker build -t darkx-ultra .

# Run
docker run -d \
  -e SESSION_ID=darkx-ultra-bot/DARKX-ULTRA_your_gist_id \
  -e OWNER_NUMBER=255775710774 \
  -p 5000:5000 \
  --name darkx-ultra \
  darkx-ultra

# Logs
docker logs -f darkx-ultra
```
...
JSON Files https://img.shields.io/badge/JSON-000000?style=flat-square&logo=json&logoColor=white Local, Termux
MongoDB https://img.shields.io/badge/MongoDB-47A248?style=flat-square&logo=mongodb&logoColor=white Cloud (recommended)
PostgreSQL https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white Cloud / VPS
MySQL https://img.shields.io/badge/MySQL-4479A1?style=flat-square&logo=mysql&logoColor=white Cloud / VPS
SQLite https://img.shields.io/badge/SQLite-003B57?style=flat-square&logo=sqlite&logoColor=white VPS (no external DB)

```env
# MongoDB
MONGO_URL=mongodb+srv://user:password@cluster.mongodb.net/darkxultra

# PostgreSQL
POSTGRES_URL=postgresql://user:password@host:5432/darkxultra

# MySQL
MYSQL_URL=mysql://user:password@host:3306/darkxultra
...
OWNER_NUMBER ✅ 255775710774 Your number, no +
BOT_NAME ❌ DARKX-ULTRA Bot display name
BOT_OWNER ❌ Mr X Developer Owner display name
PACKNAME ❌ DARKX-ULTRA Sticker pack name
...
export default {
    ...
    async handler(sock: any, message: any, args: any[], context: any = {}) {
        const {
            ...
            channelInfo       // DARKX-ULTRA branding spread
        } = context;
...
· Verify SESSION_ID starts with darkx-ultra-bot/DARKX-ULTRA_
...
https://img.shields.io/badge/Telegram-FF0000?style=for-the-badge&logo=telegram&logoColor=white
https://img.shields.io/badge/WhatsApp_Channel-25D366?style=for-the-badge&logo=whatsapp&logoColor=white
https://img.shields.io/badge/GitHub_Issues-181717?style=for-the-badge&logo=github&logoColor=white
...
MIT License · Made with ❤️ by Mr X Developer · DARKX-ULTRA
